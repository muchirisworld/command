...
import { Plus, ArchiveIcon, ArrowLeft01Icon } from "@hugeicons/core-free-icons";
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                        ...
                        <span className="text-muted-foreground text-sm">Base Unit: {product.base_unit}</span>
                    </div>
                </div>
                <div className="flex gap-2">
                    <Button variant="destructive" onClick={handleArchive} disabled={product.status === "archived"}>
                ...
                <Card className="md:col-span-2">
                    <CardHeader className="flex flex-row items-center justify-between">
                        <div>
                            ...
                            <CardDescription>Manage SKUs and pricing for this product.</CardDescription>
                        </div>
                        <Button size="sm">
                            <Link 
                    ...
                    <CardContent>
                        ...
                        <div className="bg-muted/50 rounded-lg p-8 text-center">
                            <p className="text-muted-foreground text-sm mb-2">Variant listing endpoint (GET /catalog/products/{product.id}/variants) not yet implemented.</p>
                ...
                <div className="space-y-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Define unit conversion rules (e.g. 1 Case = 12 Bottles).</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <form 
                                onSubmit={(e) => {
                            ...
                            >
                                <conversionForm.Field
                                    ...
                                    children={(field) => (
                                        <div className="space-y-1">
                                            <Label htmlFor={field.name} className="text-xs">From Unit (e.g. case)</Label>
                                            <Input
                                                id={field.name}
                                                // size="sm"
                                ...
                                <conversionForm.Field
                                    ...
                                    children={(field) => (
                                        <div className="space-y-1">
                                            <Label htmlFor={field.name} className="text-xs">Equals X {product.base_unit}</Label>
                                            <Input
                                                id={field.name}
                                                type="number"
                                                // size="sm"
                            ...
                            <div className="mt-6 border-t pt-4">
                                <h4 className="text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-2">Active Rules</h4>
                                <p className="text-xs text-muted-foreground">List conversion rules (TODO: Backend endpoint needed).</p>
                            </div>
                        </CardContent>
                    </Card>
                </div>
