        ...
        <div className="p-6 max-w-2xl mx-auto w-full">
            <div className="flex items-center space-x-2 mb-6">
                <Button variant="ghost" size="sm">
                    <Link to="/dashboard/catalog/products/$productId" params={{ productId }} className="flex items-center">
            ...
            <p className="text-muted-foreground mb-6">Add a new SKU for {product.name}.</p>
                ...
                >
                        ...
                        <form.Field
                            ...
                            children={(field) => (
                                <div className="flex items-center space-x-2 pt-2">
                                    ...
                                    />
                                    <Label htmlFor={field.name}>Active and available for sale</Label>
                                </div>
                            )}
                        />
                    </CardContent>
                    <CardFooter className="flex justify-end space-x-2 border-t pt-4">
                        <Button variant="outline" type="button">
                            <Link to="/dashboard/catalog/products/$productId" params={{ productId }}>
                                Cancel
                            </Link>
                        </Button>
                        <form.Subscribe
